...
- **[Luxafor Flag 2](https://www.amazon.com/dp/B0DTJL1ZNY)** (~$40, USB-C). The original Luxafor Flag works identically — the Flag 2 reports the exact same USB identity (vendor `0x04d8`, product `0xf372`), so all software treats them as the same device.
